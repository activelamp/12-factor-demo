...
See - "Start Services:" Understand the sequence of multiple compose files:  https://docs.docker.com/compose/reference/overview/#specifying-multiple-compose-files\
\
